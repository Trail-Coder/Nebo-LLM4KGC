...
with open("train.tsv", "r") as f:
    ...
    for line in tqdm(lines):
        ...
        full_prompt = ent0_neighbor + ent2_neighbor + "Now answer the question: Is the following assert true? " + ent2txt[ent0] + " " + rel2txt[rel] + " " + ent2txt[ent2] + ". "
        ...
        if rnd <= 0.5:
            ...
            try:
                tmp_head_neighbor = ent2neighbor[ent0]
            except Exception as e:
                tmp_head_neighbor = ''
