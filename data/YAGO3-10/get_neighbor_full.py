...
def make_2hop_sentence_pair(s: str, w: str, t: str, relations_dir, ent2txt: Dict[str, str]) -> str:
    ...
    sen1 = f"{safe_name(s, ent2txt)} {r1} {w}"
    sen2 = f"{safe_name(w, ent2txt)} {r2} {t}"
    return f"{sen1}; {sen2}."
...
def main():
    ...
    print(
        f"CSV '{csv_file}' created (YAGO3-10): 1-hop sentences + top-{topk_second} 2-hop path sentences ranked by equal-weight fusion [{FUSION_METHOD}]."
    )
